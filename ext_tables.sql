...
CREATE TABLE tx_staffdirectory_staffs (
	...
	staff_name varchar(50) DEFAULT '' NOT NULL,
	description text,
	departments int(11) DEFAULT '0' NOT NULL,
	parent_staff int(11) DEFAULT '0' NOT NULL,
...
#
CREATE TABLE tx_staffdirectory_departments (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
	tstamp int(11) DEFAULT '0' NOT NULL,
	crdate int(11) DEFAULT '0' NOT NULL,
	...
	position_title varchar(50) DEFAULT '' NOT NULL,
	position_description text,
	staff int(11) DEFAULT '0' NOT NULL,
...
#
CREATE TABLE tx_staffdirectory_members (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
	tstamp int(11) DEFAULT '0' NOT NULL,
	crdate int(11) DEFAULT '0' NOT NULL,
